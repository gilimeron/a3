...
@section('content')
    ...
    <div class="container" id='border'>
        <img src="images/billsplitter.jpg" alt="restaurantimage">
        <h1>Bill Splitter</h1>
        ...
        <form method='GET' action='/' class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type='number' name='pplCount' id='pplCount' class='form-control' value='@if($errors->get('pplCount')){{old('pplCount')}}@else{{$pplCount or ''}}@endif'>
                    * required
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type='number' step="any" name='billSum' id='billSum' class='form-control' value='@if($errors->get('billSum')){{old('billSum')}}@else{{$billSum or ''}}@endif'>
                    * required
                </div>
            </div>
