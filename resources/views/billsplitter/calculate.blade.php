...
<div class="container" id='border'>
    ...
    <form method='GET' action='/' class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type='text' name='pplCount' id='pplCount' class='form-control' value='{{ $pplCount or '' }}'>
                * required
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type='text' name='billSum' id='billSum' class='form-control' value='{{ $billSum or '' }}'>
                * required
            </div>
        </div>
